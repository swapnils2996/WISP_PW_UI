...
- Name: IntermittentTestCases.spec.ts >> Intermittent Test Cases - Defect Verification >> ITC-DEF-001 - Home page ISP Application Version is visible and non-empty
- Location: tests/IntermittentTestCases.spec.ts:58:7

# Error details

```
Error: ISP Application Version row should be visible on home page
