...
- Name: electronicBusinessForms.spec.ts >> Electronic Business Forms >> EBF_AUR_WTC05 - Add to Deletions section and verify Please Read info box and buttons
- Location: tests/electronicBusinessForms.spec.ts:139:7
...
Call log:
  - waiting for locator('app-alarm-update-report').locator('input[type="text"]').nth(8)
