...
- Name: orderReceiving.spec.ts >> Order & Receiving >> OR_WTC29 - Cancel PO item shows confirmation dialog
- Location: tests/orderReceiving.spec.ts:486:7
        ...
        - generic [ref=e54]:
          ...
          - generic [ref=e59]:
            - generic [ref=e62]:
              ...
              - button "Receive" [ref=e66] [cursor=pointer]
              - button "View Rcvs" [ref=e68] [cursor=pointer]
              - button "Cancel" [disabled] [ref=e70]
              - button "Print" [ref=e72] [cursor=pointer]
            - generic [ref=e77]:
              - combobox [ref=e79]:
